    ...
    render() {
        ...
        const openItemInfo = () => {
            ...
            if(this.props.details.colors) {
                localStorage.setItem('productColors', JSON.stringify(this.props.details.colors));
            }
            else {
        ...
        return (
            <Link to={`/${this.props.details.category}/${this.props.details.name}`} className="category__items--item" onClick={openItemInfo}><div>
